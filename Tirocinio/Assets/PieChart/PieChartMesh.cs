...
namespace UnityEngine.XR.Tirocinio
{
    public class PieChartMesh : MonoBehaviour
    {
        ...
        public void Init(float[] data, Material mainMaterial, GameObject otherobject, PieChartMeshController.AnimationType animationType)
        {
        ...
        public IEnumerator Draw()
        {
            ...
            for (int i = 0; i < mData.Length; i++)
            {
                ...
                gameObjs[i].transform.localScale = new Vector3(0.878767f, 0.878767f, 0.01f);
                GameObject.Find("PieChart").GetComponent<PieChart>().deleteObjects.Add(gameObjs[i]);
